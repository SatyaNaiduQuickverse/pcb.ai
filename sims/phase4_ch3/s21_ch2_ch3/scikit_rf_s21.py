#!/usr/bin/env python3
"""S21 CH2↔CH3 coupling. NE↔SE adjacent ~30mm separation."""
import math, sys
...
print(f"PR-CH3 CH2↔CH3 S21 coupling (adjacent ~30mm):")
...
with open("s21_result.txt", "w") as f:
    f.write(f"PR-CH3 CH2↔CH3 S21 @ 100MHz: {s21_db:.2f} dB (≤-40 PASS)\n")
