...
- Reads ch1_thermal_v4_full4ch from full4ch_mesh_fine/full4ch_thermal_fine.vtu_t0002.vtu
- Executed: /home/novatics64/local/elmer/bin/ElmerSolver full4ch_thermal_fine.sif
- Result file mtime > sif mtime (verified via ls -la)
"""
import meshio, numpy as np, glob

vtus = sorted(glob.glob('full4ch_mesh_fine/full4ch_thermal_fine.vtu_*.vtu'))
