#!/usr/bin/env python3
"""S21 ch2_ch4 via Hammerstad model."""
import math, sys
...
print(f"PR-CH4 ch2_ch4 S21 (sep={trace_sep*1000:.0f}mm): {s21_db:.2f} dB (≤-40)")
print(f"Verdict: {'PASS' if s21_db <= -40 else 'FAIL'}")
with open("s21_result.txt", "w") as fh: fh.write(f"ch2_ch4 S21 @ 100MHz: {s21_db:.2f} dB\n")
