...
|---|---|---|---|---|---|
| +BATT (6S, 18.0–25.2 V) | LiPo battery direct → 2× MF72 5D25 parallel NTC ICL → **4× Infineon BSC014N06NS rev-pol FETs** (Phase 2-burst-resize upgrade from AON6260; 1.45 mΩ each → 0.36 mΩ cluster, 680 A continuous capability) → **3× Panasonic EEHZS1V471P bulk caps** (Phase 2-burst-resize upgrade from 2× aluminum electrolytic; hybrid polymer-Al, 1410 µF total, 4A RMS each) → SMBJ33A TVS | NTC: MF72 5D25; rev-pol: BSC014N06NS; bulk: EEHZS1V471P; TVS: SMBJ33A | C116485 × 2; **C113391** × 4; **C403803** × 3; existing | bus (16 A inrush ceiling) | 400 A peak board-total (4× 100A burst per channel) / 280 A cont (4×70A) |
