...
# PR-A4-e 2026-05-23: CH2/3/4 passive instantiation via mirror
# Generated by build_ch234_passives.py — 192 passives (64 per channel × 3)
try:
...
def place_channels_234_passives(fps_by_ref, placements):
    """A4-e: instantiate CH2/3/4 passives via mirror of CH1."""
    placed = 0
...
ALL_PLACERS = [
    ...
    ('S4 CH234 passives', 'CH2/3/4 passives mirror', place_channels_234_passives),
]
